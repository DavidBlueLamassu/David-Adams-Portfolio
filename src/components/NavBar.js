  ...
  return (
    ...
    <nav className="sticky top-0 z-10">
      ...
      {/* When the value of showNav === true then the hamburger menu is displayed; when it is false the menu is not displayed (is
        ...
        screens and up) are displayed. All menu items are set to change from the default color to black upon hover. The frosted 
        navbar effect derives, in part, from code in Jon Catmull's answer to a query in "Stack Overlow": Chad Johnson, "How can I make a CSS glass/blur effect work for an overlay?", Stack Overflow (20 December 2014), last viewed 1 August 2023: 
